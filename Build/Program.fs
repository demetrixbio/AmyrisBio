...
let gitRaw =
    Environment.environVarOrDefault "gitRaw" "https://raw.github.com/Amyris"
...
let initTargets () =
    ...
    Target.create "Clean" (fun _ -> Shell.cleanDirs [ "bin"; "temp"; "src/AmyrisBio/bin"; "tests/AmyrisBio.Tests/bin" ])
    ...
    Target.create "RunTests" (fun _ -> DotNet.test id "tests/AmyrisBio.Tests")
